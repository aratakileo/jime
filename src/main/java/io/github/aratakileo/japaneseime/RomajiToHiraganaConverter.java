...
public class RomajiToHiraganaConverter {
    ...
    private final static LinkedHashMap<String, String> HIRAGANA = new LinkedHashMap<>() {{
        put("a", "あ");
        put("i", "い");
        put("yi", "い");
        put("u", "う");
        ...
        for (final var entry: new LinkedHashMap<>(this).entrySet()) {
            ...
            if (!StringUtils.startsWithAny(romajiLiteral, "a", "i", "u", "e", "o", "n"))
                put(romajiLiteral.charAt(0) + romajiLiteral, "っ" + HIRAGANA);
        }
    }};
    ...
    private final static String[] ROMAJI_LITERALS = HIRAGANA.keySet().toArray(new String[0]),
